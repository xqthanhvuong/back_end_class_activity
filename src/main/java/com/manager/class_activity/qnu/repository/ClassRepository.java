...
public interface ClassRepository extends JpaRepository<Class, Integer> {
    ...
    List<Class> findAllByDepartment_IdAndIsDeleted(Integer departmentId, boolean b);
    ...
    @Modifying
    @Transactional
    @Query("update Class c set c.isDeleted = true where c.course.id = :courseId")
    void deleteByCourseId(int courseId);

    @Modifying
    @Transactional
    @Query("update Class c set c.isDeleted = true where c.department.id = :departmentId")
